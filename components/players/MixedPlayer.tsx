    ...
    <div className="space-y-8">
      ...
      <div className="flex justify-between pt-8 border-t border-slate-200">
        ...
        <div className="flex flex-col items-end">
            <button onClick={next} disabled={!stepCompleted} className={`px-8 py-3 rounded-xl flex items-center gap-2 transition-all font-bold shadow-lg ${stepCompleted ? 'bg-cyan-600 text-white hover:bg-cyan-700 animate-bounce cursor-pointer' : 'bg-slate-800 text-white disabled:opacity-50 disabled:cursor-not-allowed'}`}>
